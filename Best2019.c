...
task main()
{
	while (true)
	{
		...
		/*straightChannel = vexRT[Ch3];
		turningChannel = vexRT[Ch1];
		forwards = (straightChannel) * (straightChannel) * 100;
		backwards = -1 * (straightChannel) * (straightChannel) * 100;
		turning = (turningChannel) * (turningChannel) * 50; 
